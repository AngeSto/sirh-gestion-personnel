...
public class NouveauCollaborateursController extends HttpServlet{
	...
	public void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		collaboService.sauvegarderCollabo(new Collaborateur(req.getParameter("Nom"), req.getParameter("Prenom"), req.getParameter("Adresse"), req.getParameter("NumeroSecu"), LocalDate.parse(req.getParameter("DateNaissance"), DateTimeFormatter.ofPattern("yyyy-MM-dd"))));
